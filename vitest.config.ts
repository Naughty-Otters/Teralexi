  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/main/channels/discord/**',
        'src/main/channels/slack/**',
        'src/main/channels/telegram/**',
        'src/main/channels/wechat/**',
        'src/main/channels/whatsapp/**',
        'src/main/channels/framework/conversation-bridge.ts',
      ...
      thresholds: {
        ...
        'src/main/skills/extension-*.ts': {
          lines: 85,
          statements: 85,
          functions: 85,
          branches: 70,
        },
        'src/main/agent/hooks/hook-*-executor.ts': {
          lines: 85,
          statements: 85,
          functions: 85,
          branches: 70,
        },
        'src/main/agent/hooks/user-hooks.ts': {
          lines: 85,
          statements: 85,
          functions: 85,
          branches: 75,
        },
        'src/main/agent/providers/extension-llm-provider-registry.ts': {
          lines: 85,
          statements: 85,
          functions: 85,
          branches: 85,
        },
        'src/main/main-app.ts': {
          lines: 85,
          statements: 85,
          functions: 70,
          branches: 70,
