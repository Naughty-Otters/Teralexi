import { TERALEXI_PLATFORM_PATHS } from './teralexi-platform-api'
...
export const TERALEXI_DESKTOP_RELEASES_DEFAULT_PATH =
  TERALEXI_PLATFORM_PATHS.desktopReleases
...
/** @deprecated Releases are served via authenticated API + S3, not public GitHub Releases. */
export const RELEASE_GITHUB_REPO = 'Teralexi'
