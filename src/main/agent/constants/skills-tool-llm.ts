...
If valid, summary must briefly confirm how this step's requirements are met.`,
  ...
  PLAN_EXECUTION_DISCIPLINE: `Approved plan execution: complete only the current step goal, then stop. You may call update_todos during the step to sync task status or revise the list, and exit_plan_mode when leaving planning is appropriate. Do not call enter_plan_mode. Do not start work from other plan steps — reply with a brief summary when this step is done.`,
