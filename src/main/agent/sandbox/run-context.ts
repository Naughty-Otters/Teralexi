...
/** Active assistant message id for the current agent turn (follow-up catalog source). */
export const TERALEXI_AGENT_ASSISTANT_MESSAGE_ID_ENV =
  'TERALEXI_AGENT_ASSISTANT_MESSAGE_ID' as const

export const ASSISTANT_MESSAGE_ID_GLOBAL_KEY =
  '__TERALEXI_AGENT_ASSISTANT_MESSAGE_ID__' as const
