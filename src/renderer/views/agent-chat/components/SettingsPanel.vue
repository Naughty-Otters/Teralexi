...
const tabs = computed(() => [
  ...
  { id: 'skills' as SettingsTab, label: t.value.settings.tabs.skills, requiresSignIn: false },
  { id: 'agents' as SettingsTab, label: t.value.settings.tabs.agents, requiresSignIn: false },
  { id: 'llm' as SettingsTab, label: t.value.settings.tabs.llm, requiresSignIn: false },
  { id: 'channels' as SettingsTab, label: t.value.settings.tabs.channels, requiresSignIn: false },
  { id: 'scheduler' as SettingsTab, label: t.value.settings.tabs.scheduler, requiresSignIn: false },
  { id: 'memory' as SettingsTab, label: t.value.settings.tabs.memory, requiresSignIn: false },
