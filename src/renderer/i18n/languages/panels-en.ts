...
export const settingsPanelsEn: SettingsPanelLabels = {
  ...
  developer: {
    ...
    stressTitle: 'Stress test harness',
    stressDesc:
      'Long-running multi-skill soak. Visible only when launched with TERALEXI_STRESS_TEST=1 or --stress-test.',
    stressWarning:
      'While running, tool approvals are auto-approved and coding/website work uses ~/.teralexi/stress-workspace. Destructive or outbound tools may run without prompts.',
    stressScenario: 'Scenarios',
    stressScenarioAll: 'Select all',
    stressScenarioNone: 'Clear',
    stressDuration: 'Duration',
    stressCustom: 'Custom',
    stressCustomDuration: 'Custom duration',
    stressInputMode: 'Input mode',
    stressModeHybrid: 'Hybrid (script then AI continue)',
    stressModeCycle: 'Cycle scripted list',
    stressModeAi: 'AI-continue only',
    stressConcurrency: 'Execution',
    stressConcurrencySequential: 'Sequential (round-robin)',
    stressConcurrencyConcurrent: 'Concurrent (all skills in parallel)',
    stressStart: 'Start stress test',
    stressStop: 'Stop',
    stressRunning: 'Running…',
    stressOpenReport: 'Open report folder',
    stressElapsed: 'Elapsed',
    stressSkill: 'Skill',
    stressTurn: 'Turn',
    stressLatency: 'Last latency',
  },
  googleWorkspace: {
    intro:
  ...
  about: {
    ...
    legalTitle: 'Privacy & support',
    legalIntro:
      'Review how Teralexi handles data, contact Naughty Otters LLC, or get product help.',
  ...
  extensions: {
    ...
    hooks: 'Hooks',
    contributedHooks: 'Contributed hooks',
    permissions: 'Permissions',
    empty: 'Select an extension to view details.',
    project: 'Project',
    reviewRequired: 'Review required',
    approveHooks: 'Approve',
    rejectHooks: 'Reject',
    pendingHooks: 'Pending reviews',
    contributedProviders: 'LLM providers',
    contributedChannels: 'Channels',
    contributedPanels: 'UI panels',
    trustRequiredHint:
      'Approve pending reviews below to activate providers, channels, and panels from this extension.',
    contributionsInactive: 'Disabled — turn on the extension to activate contributions.',
    active: 'Active',
    inactive: 'Inactive',
  },
  mcp: {
