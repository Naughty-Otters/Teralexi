...
function setSandboxOutputScope(scope) {
  const g = globalThis;
  if (scope?.trim()) {
    const v = scope.trim();
...
function defaultToolLoopPreviewDir(sandboxRoot) {
  return (0, import_path5.join)(sandboxRoot, "output", TOOL_LOOP_OUTPUT_SEGMENT);
}
...
function resolveScopedSandboxPath(sandboxRoot, userPath) {
  const trimmed = userPath.trim();
  if (import_path7.default.isAbsolute(trimmed)) {
...
var sandbox_paths_exports = {};
__export(sandbox_paths_exports, {
  OTTER_AGENT_SANDBOX_OUTPUT_SCOPE_ENV: () => OTTER_AGENT_SANDBOX_OUTPUT_SCOPE_ENV,
  OTTER_AGENT_SANDBOX_ROOT_ENV: () => OTTER_AGENT_SANDBOX_ROOT_ENV,
  OTTER_AGENT_WORKSPACE_PATH_ENV: () => OTTER_AGENT_WORKSPACE_PATH_ENV,
  SANDBOX_OUTPUT_SCOPE_GLOBAL_KEY: () => SANDBOX_OUTPUT_SCOPE_GLOBAL_KEY,
  SANDBOX_ROOT_GLOBAL_KEY: () => SANDBOX_ROOT_GLOBAL_KEY,
  WORKSPACE_PATH_GLOBAL_KEY: () => WORKSPACE_PATH_GLOBAL_KEY,
  assertMoveAllowed: () => assertMoveAllowed,
  defaultToolLoopPreviewDir: () => defaultToolLoopPreviewDir,
  ensureToolLoopStepOutputDirs: () => ensureToolLoopStepOutputDirs,
  getConversationIdFromEnv: () => getConversationIdFromEnv,
  getOutputResultsRelPrefix: () => getOutputResultsRelPrefix,
  getOutputScriptsRelPrefix: () => getOutputScriptsRelPrefix,
  getSandboxOutputScopeFromEnv: () => getSandboxOutputScopeFromEnv,
  getSandboxRootFromEnv: () => getSandboxRootFromEnv,
  getWorkspacePathFromEnv: () => getWorkspacePathFromEnv,
  isPathInFilesystemContext: () => isPathInFilesystemContext,
  isPathInsideSandbox: () => isPathInsideSandbox,
  isPathInsideWorkspace: () => isPathInsideWorkspace,
  isPseudoAbsoluteProjectPath: () => isPseudoAbsoluteProjectPath,
  isSandboxArtifactRelativePath: () => isSandboxArtifactRelativePath,
  remapLegacyPlanRelativePath: () => remapLegacyPlanRelativePath,
  remapLegacySharedOutputPath: () => remapLegacySharedOutputPath,
  requireActiveSandbox: () => requireActiveSandbox,
  resolvePathAllowingOutside: () => resolvePathAllowingOutside,
  resolvePathInContext: () => resolvePathInContext,
  resolvePathMustBeInside: () => resolvePathMustBeInside,
  resolveSandboxRelativePath: () => resolveSandboxRelativePath,
  resolveScopedPathInContext: () => resolveScopedPathInContext,
  resolveScopedSandboxPath: () => resolveScopedSandboxPath,
  resolveUserProjectPath: () => resolveUserProjectPath,
  sandboxPathError: () => sandboxPathError,
  setSandboxOutputScope: () => setSandboxOutputScope,
  toolLoopOutputRelBase: () => toolLoopOutputRelBase
});
module.exports = __toCommonJS(sandbox_paths_exports);
...
//# sourceMappingURL=e165ae0f8b58f17db6171db5e337fcb30ab5b59a.js.map
